...
function. This function will also update the modeled precipitable water vapor
for Kitt Peak National Observatory to represent the new measurements.
...
function is run. To retrieve this model, use the ``modeled_pwv`` function.
...
To retrieve the modeled PWV level over for November 14th, 2016:
