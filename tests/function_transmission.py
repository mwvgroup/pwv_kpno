...
from pwv_kpno.pwv_atm import trans_from_date
...
class TransmissionResults(unittest.TestCase):
    ...
    def test_airmass_dependence(self):
        ...
        airmass_2_transm = trans_from_date(date_35, 2, self.mock_model)
        airmass_1_transm = trans_from_date(date_40, 1, self.mock_model)
    ...
    def test_column_units(self):
        ...
        sample_transm = trans_from_date(datetime(2011, 1, 1, tzinfo=utc), 1)
