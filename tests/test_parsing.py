...
from pwv_kpno.data_management import SuomiFileParser
...
class DateFormatConversion(TestCase):
    ...
    def test_round_off_error_correction(self):
        ...
        self.assertEqual(
            SuomiFileParser._suomi_date_to_timestamp(2010, '1.05208'),
